...
public class ViewStudentRecordActivit extends Activity implements OnItemClickListener, OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            listview.setAdapter(new RecordArrayAdapte(this, R.layout.list_item, studentList, techerDao));
