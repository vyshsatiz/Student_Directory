...
public class ViewTeacherRecordActivit extends Activity implements OnItemClickListener, OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            listview.setAdapter(new RecordArrayAdapte(this, R.layout.list_item, teacherList, teacherDao));
